...
namespace Mirror
{
    ...
    public class NetworkPingDisplay : NetworkedBehaviour
    {
        ...
        void OnGUI()
        {
            ...
            string text = string.Format(format, (int)((NetworkingManager.Singleton.GetComponent<UnetTransport>().GetCurrentRtt(OwnerClientId) / rttMultiplier)));
